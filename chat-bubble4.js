  ...
  async function initApp() {
    ...
    const ChatBubble = () => {
      ...
      return React.createElement(React.Fragment, null, [
        ...
        React.createElement('div', {
          ref: chatWindowRef,
          className: `notify-fixed notify-bottom-0 notify-right-0 notify-md:bottom-24 notify-md:right-6 notify-w-full notify-md:w-[400px] notify-bg-white notify-rounded-t-lg notify-md:rounded-lg notify-shadow-xl notify-flex notify-flex-col notify-z-40 notify-transition-all notify-duration-300 ${
            isChatOpen ? 'notify-opacity-100 notify-h-[85vh] notify-md:h-[80vh]' : 'notify-opacity-0 notify-h-0 notify-md:h-0 notify-pointer-events-none'
          }`,
                        ...
                        React.createElement('div', { 
                          ...
                          React.createElement('div', { 
                            className: `notify-rounded-2xl notify-p-4 ${
                              msg.sender === 'user' 
                                ? 'notify-bg-green-600 notify-text-white notify-rounded-br-none' 
                                : 'notify-bg-gray-100 notify-text-gray-800 notify-rounded-bl-none'
                            }`,
                            key: "message-text"
                          }, msg.text),
                          React.createElement('div', { 
