(function () {
  ...
  // Namespace for the chat bubble
  window.NotifyChatBubble = {
    initialize: async (config = {}) => {
      // Merge configuration with defaults from data attributes
      ...
      // Add styles with prefix to avoid conflicts
      function addStyles() {
      ...
      // Display fallback UI for unsupported browsers or errors
