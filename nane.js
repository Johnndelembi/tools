(function() {
  ...
  function addStyles(shadowRoot) {
    ...
    style.textContent = `
      ...
      /* Animation Styles */
      .notify-scale-out {
        animation: notify-scale-out 0.2s ease-in-out forwards;
      }
      
      .notify-scale-in {
        animation: notify-scale-in 0.2s ease-in-out forwards;
      }
  ...
  async function initApp() {
    ...
    const RefreshIcon = (props) => (
      React.createElement('svg', {
        ...
        React.createElement('path', { d: "M21.5 2v6h-6M2.5 22v-6h6", key: "1" }),
        React.createElement('path', { d: "M2 11.5a10 10 0 0 1 18.8-4.3M22 12.5a10 10 0 0 1-18.8 4.3", key: "2" })
      ])
    );
    ...
    const ChatBubble = () => {
      ...
      const handleOutsideClick = (e) => {
        // Only close if clicking specifically on the overlay element
        if (e.target.classList.contains('notify-overlay')) {
          toggleChat();
        }
      };
      ...
      return React.createElement(React.Fragment, null, [
        ...
        React.createElement('div', {
          ...
          className: `notify-fixed 
            ...
            notify-shadow-xl notify-flex notify-flex-col notify-z-50
            notify-transition-all notify-duration-300
            ${isChatOpen ? 'notify-opacity-100 notify-scale-in' : 'notify-opacity-0 notify-scale-out notify-pointer-events-none'}`,
          ...
          React.createElement('div', { 
            ...
            React.createElement('div', { className: "notify-flex notify-items-center notify-justify-between" }, [
              ...
              React.createElement('div', { className: "notify-flex notify-items-center notify-gap-2" }, [
                React.createElement('button', {
                  ...
                  key: "refresh-button"
                }, React.createElement(RefreshIcon, { className: "notify-w-5 notify-h-5 notify-text-green-900" })),
                React.createElement('button', {
                  onClick: toggleChat,
                  className: "notify-w-8 notify-h-8 notify-rounded-full notify-bg-white/20 notify-hover:bg-white/40 notify-flex notify-items-center notify-justify-center notify-transition-colors",
